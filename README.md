...
queue desingned for distributed processing with strict control over execution, 
...
omniq = OmniqClient(host="redis", port=6379)
...
All admnistrative operations are `executed atomically via Lua`, ensuring 
...
the examples avaliable in the `./examples` folder.
...
## License
GPL-3.0
Refer to the main repository for datails
